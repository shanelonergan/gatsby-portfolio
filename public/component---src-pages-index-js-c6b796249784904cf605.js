  ...
  Array(281).concat([
    function(e, t, n) {
      ...
      function Se(e, t) {
            ...
            setProps: function(t) {
              ...
              (r.ignoreAttributes = V(t.ignoreAttributes, n.ignoreAttributes)),
                ...
                n.interactiveDebounce !== r.interactiveDebounce &&
                  (ce(), (g = W(Ne, r.interactiveDebounce)));
              Ae(b, n, r),
        ...
        function Te() {
          M() && (Se('touchstart', Pe, ie), Se('touchend', Me, ie)),
        ...
        function De() {
          ...
          var l = k({ eventsEnabled: !1, placement: E.props.placement }, n, {
            modifiers: k({}, n && n.modifiers, {
              ...
              arrow: k({ element: r, enabled: !!r }, P(n, 'arrow')),
              offset: k({ offset: E.props.offset }, P(n, 'offset')),
            }),
            onCreate: function(e) {
      ...
      function Ze(e) {
        ...
        return (
          ...
          i.a.createElement(
            ...
            y && Object(Ne.createPortal)(n, w.container),
          )
        );
      }
      ...
      (At.propTypes = {
        x: Pe.a.oneOf(['left', 'right']),
        y: Pe.a.oneOf(['top', 'bottom']),
        round: Pe.a.bool,
      }),
              ...
              (a = 59 === e.charCodeAt(M)) &&
                ...
                w
                  ? ($(),
                    ...
                    J.push(w),
                    (P = Q()).offset++,
                    H && H.call(W, w, { start: j, end: P }, e.slice(E - 1, M)),
                    (j = P))
                  : ((p = e.slice(E - 1, M)),
                    (X += p),
                    (G += p.length),
    ...
    function(e) {
      e.exports = JSON.parse(
        '{"data":{"contentfulAbout":{"name":"Shane","roles":["Web Developer 👨‍💻","React Lover ⚛️","Ruby on Rails Engineer 💎","JavaScript Wrangler 🤠"],"socialLinks":[{"id":"d346bda6-36b7-511c-a363-b79320d1d6a1","url":"https://github.com/shanelonergan","name":"Github","fontAwesomeIcon":"github"},{"id":"0e71cbfd-ee90-56a5-b365-d538d8a7171a","url":"https://www.blog.shanelonergan.dev/","name":"Blog","fontAwesomeIcon":"keyboard"},{"id":"84da2bc3-d7ca-5fb9-add6-a01b3df06489","url":"https://shane823656.typeform.com/to/gXwRT3","name":"Contact me","fontAwesomeIcon":"envelope"},{"id":"e45de385-02a6-50fd-a389-dfff147b3698","url":"https://twitter.com/shane__lonergan","name":"Twitter","fontAwesomeIcon":"twitter"},{"id":"0806eb36-0fa8-5de9-b954-4a5538addcb0","url":"https://www.linkedin.com/in/shane-lonergan/","name":"LinkedIn","fontAwesomeIcon":"linkedin"},{"id":"fb541ad5-8e00-5945-b9bd-11503b6fe279","url":"https://dev.to/shane__lonergan","name":"DEV","fontAwesomeIcon":"dev"}]},"site":{"siteMetadata":{"deterministicBehaviour":false}}}}',
      );
    },
    ,
    function(e, t, n) {
          ...
          if (
            ...
            if (y)
              if ('\t' === (c = t.charAt(R))) (Z += 4 - (Z % 4)), R++;
                ...
                for (N = R + 4; R < N && ' ' === t.charAt(R); ) R++, Z++;
                R === N && ' ' === t.charAt(R) && ((R -= 3), (Z -= 3));
              } else '\n' !== c && '' !== c && (y = null);
          }
          if (y) {
            if (!_ && u !== y) break;
...
//# sourceMappingURL=component---src-pages-index-js-c6b796249784904cf605.js.map
